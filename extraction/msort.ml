...
(** val sort_prog_split : int list -> int list -> int list -> int list **)

let sort_prog_split _ l' l'0 =
  merge l'0 l'

(** val msort_prog : int list -> int list **)

let msort_prog =
  div_conq_split sort_prog_base sort_prog_one (fun ls h h0 ->
    sort_prog_split ls h0 h)
